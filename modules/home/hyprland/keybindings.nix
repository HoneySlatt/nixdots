...

{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mainMod, W, exec, quickshell ipc -p ~/.config/quickshell/bar -n call togglePosition call"
      ...
      "$mainMod SHIFT, C, exec, kitty -e couik"
