...

{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mainMod, O, exec, $terminal -e glow ~/Obsidian\\ Vault/"
      ...
      "$mainMod, C, exec, ghostty -e claude"
      "$mainMod SHIFT, C, exec, ghostty -e opencode"
      "$mainMod, N, exec, ghostty -e nvim"
      "$mainMod, TAB, exec, qs ipc -c bar call overview toggle"
      "ctrl alt, delete, exec, ghostty -e btop"
