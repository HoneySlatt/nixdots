...

{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mainMod, T, exec, if hyprctl getoption general:layout | grep -q dwindle; then hyprctl keyword general:layout scrolling; else hyprctl keyword general:layout dwindle; fi"
      "$mainMod, space, exec, $menu"
      "$mainMod, P, exec, hyprpicker"
      "$mainMod, S, exec, hyprquickshot-toggle"
      "$mainMod, W, exec, quickshell ipc -p ~/.config/quickshell/bar -n call toggleVisibility call"
      "$mainMod SHIFT, W, exec, quickshell ipc -p ~/.config/quickshell/bar -n call togglePosition call"
      "$mainMod CTRL, W, exec, quickshell ipc -p ~/.config/quickshell/bar -n call toggleTaskbar call"
      "$mainMod, B, exec, firefox"
      "$mainMod, M, exec, cider-2"
      "$mainMod, D, exec, vesktop"
      "$mainMod, O, exec, obsidian"
      ''$mainMod SHIFT, O, exec, $terminal zsh -c "yazi ~/Obsidian\ Vault/"''
      "$mainMod SHIFT, M, exec, kitty -e aerc"
      "$mainMod SHIFT, N, exec, jellyfin-desktop"
      "$mainMod SHIFT, S, exec, sunshine"
      ...
      ''$mainMod SHIFT, C, exec, kitty -e sh -c 'cliphist list | fzf | cliphist decode | wl-copy' ''
