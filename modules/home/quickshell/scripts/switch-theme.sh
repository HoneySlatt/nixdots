#!/usr/bin/env bash
# Switch Nix theme — ghostty, yazi, neovim, hyprland, gtk, fastfetch
...
switch_ghostty() {
  ...
  cat > "$HOME/.config/ghostty/themes/current.conf" << EOF
# ${C[name]} — auto-generated by switch-theme.sh
foreground = ${C[text]}
background = ${C[base]}
cursor-color = ${C[rosewater]}
cursor-text = ${C[base]}
selection-background = ${C[rosewater]}
...
EOF
  ...
  local sites=(youtube twitch twitter instagram reddit github codeberg tuta claude anilist duckduckgo wikipedia chatgpt)
