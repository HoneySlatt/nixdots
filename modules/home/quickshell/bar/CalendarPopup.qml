...
Item {
    ...
    // ── MPRIS player reference — prefer the one currently playing ──
    ...
    readonly property var _cavaProc: Process {
        ...
        stdout: SplitParser {
            ...
            onRead: data => {
                ...
                calendarPopup.cavaValues = parts.map(v => parseInt(v) || 0);
            }
        }
                                ...
                                Column {
                                    ...
                                    Item {
                                        ...
                                        Canvas {
                                            ...
                                            onArtUrlChanged: {
                                                if (artUrl) { loadImage(artUrl); requestPaint(); }
                                                else calendarPopup.coverAccentColor = Theme.accent;
                                            }
                                            onImageLoaded: requestPaint()
                                            onPaint: {
                                                var ctx = getContext("2d");
                                        ...
                                        Canvas {
                                            ...
                                            onPaint: {
                                                ...
                                                for (let i = 0; i < n; i++) {
                                                    ...
                                                    let a1 = midAngle + step / 2 - gap;
                                                    let outerR = innerR + barH;
                                                    ctx.beginPath();
